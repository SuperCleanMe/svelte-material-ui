...
import { H as H6 } from './H6.c8e6be28.js';
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$props = exclude_internal_props($$props);
  return [element, use, forwardEvents, $$props, forwardEventsAdditional, $$scope, slots, h5_binding];
}
