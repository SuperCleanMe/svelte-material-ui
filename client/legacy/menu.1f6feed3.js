...
import { S as SelectionGroupIcon } from './SelectionGroupIcon.33e8964f.js';
...
function create_default_slot_11(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(i, file$1, 86, 18, 2927);
    },
    m: function mount(target, anchor) {
...
function create_default_slot_7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(i, "class", "material-icons");
      add_location(i, file$1, 97, 18, 3361);
    },
    m: function mount(target, anchor) {
      insert_dev(target, i, anchor);
      append_dev(i, t);
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(pre0, file$1, 73, 2, 2472);
      set_style(div5, "min-width", "100px");
      add_location(div5, file$1, 78, 4, 2553);
      add_location(div6, file$1, 75, 2, 2520);
      attr_dev(pre1, "class", "status");
      add_location(pre1, file$1, 112, 2, 3744);
      attr_dev(pre2, "class", "status");
      add_location(pre2, file$1, 113, 2, 3797);
      attr_dev(pre3, "class", "status");
      add_location(pre3, file$1, 114, 2, 3850);
      set_style(div7, "padding-top", "200px");
      add_location(div7, file$1, 116, 2, 3899);
    ...
    p: function update(ctx, dirty) {
      ...
      if (!current || dirty[0] &
      /*anchor2Classes*/
      16 && div3_class_value !== (div3_class_value =
      /*anchor2Classes*/
      ctx[4].join(" "))) {
        attr_dev(div3, "class", div3_class_value);
      }
      ...
      /*anchor2Classes*/
      16) Anchor_action.update.call(null, {
        classForward:
        /*Anchor_function*/
        ctx[26]
      });
      ...
      if (!current || dirty[0] &
      /*selected1*/
      128) set_data_dev(t17,
      /*selected1*/
      ctx[7]);
      if (!current || dirty[0] &
      /*selected2*/
      256) set_data_dev(t20,
      /*selected2*/
      ctx[8]);
      if (!current || dirty[0] &
      /*clicked2*/
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  var Anchor_function = function Anchor_function(classes) {
    return $$invalidate(4, anchor2Classes = classes);
  };
  ...
  $$self.$inject_state = function ($$props) {
    ...
    if ("anchor2Classes" in $$props) $$invalidate(4, anchor2Classes = $$props.anchor2Classes);
    if ("clicked" in $$props) $$invalidate(5, clicked = $$props.clicked);
    if ("clicked2" in $$props) $$invalidate(6, clicked2 = $$props.clicked2);
    if ("selected1" in $$props) $$invalidate(7, selected1 = $$props.selected1);
    if ("selected2" in $$props) $$invalidate(8, selected2 = $$props.selected2);
  };
  ...
  return [menu, menu2, menu3, anchor2, anchor2Classes, clicked, clicked2, selected1, selected2, SMUI_action_handler, SMUI_action_handler_1, SMUI_action_handler_2, SMUI_action_handler_3, click_handler, SMUI_action_handler_4, SMUI_action_handler_5, SMUI_action_handler_6, SMUI_action_handler_7, menu1_binding, click_handler_1, SMUI_action_handler_8, SMUI_action_handler_9, SMUI_action_handler_10, SMUI_action_handler_11, menu2_1_binding, menu2_1_anchorElement_binding, Anchor_function, div3_binding, click_handler_2, SMUI_action_handler_12, SMUI_action_handler_13, SMUI_action_handler_14, menu3_1_binding];
}
