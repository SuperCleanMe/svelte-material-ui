...
function add_css() {
  ...
  style.textContent = "p.svelte-1jzedyu{padding:10px;border-radius:5px}.unbounded.svelte-1jzedyu{display:inline-flex;width:50px;height:50px;justify-content:center;align-items:center;border-radius:50%;font-size:20px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(span, "class", span_class_value = "unbounded " +
      /*rippleClasses*/
      ctx[0].join(" ") + " svelte-1jzedyu");
      ...
      add_location(p2, file, 23, 2, 549);
      attr_dev(p3, "tabindex", "0");
      attr_dev(p3, "class", "svelte-1jzedyu");
      add_location(p3, file, 27, 2, 641);
    ...
    p: function update(ctx, _ref) {
      ...
      if (dirty &
      /*rippleClasses*/
      1 && span_class_value !== (span_class_value = "unbounded " +
      /*rippleClasses*/
      ctx[0].join(" ") + " svelte-1jzedyu")) {
        attr_dev(span, "class", span_class_value);
      }

      if (Ripple_action_1 && is_function(Ripple_action_1.update) && dirty &
      /*rippleClasses*/
      1) Ripple_action_1.update.call(null, {
        ripple: true,
        unbounded: true,
        color: "surface",
        classForward:
...
function instance($$self, $$props, $$invalidate) {
  ...
  var Ripple_function = function Ripple_function(classes) {
    return $$invalidate(0, rippleClasses = classes);
  };
  ...
  return [rippleClasses, Ripple_function];
}
