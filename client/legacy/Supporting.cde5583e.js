...
var file$1 = "../packages/common/Img.svelte";
...
function create_fragment$1(ctx) {
  ...
  /*$$props*/
  ctx[4], ["element", "use", "forwardEvents", "alt"])];
  var img_data = {};
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$props = exclude_internal_props($$props);
  return [element, alt, use, forwardEvents, $$props, forwardEventsAdditional, img_binding];
}

var Img = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Img, _SvelteComponentDev);

  var _super = _createSuper$1(Img);
